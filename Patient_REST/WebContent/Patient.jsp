...
<body>
	...
	<div class="container">
		...
		<form name="patientSignUp" id="patientSignUp" method="POST"
			...
			<div class="row">
				<div class="col">
					<label>Password<label_1> *</label_1></label><br /> <input
						type="password" placeholder="Enter Password" name="password"
						id="password" class="form-control form-control-sm"><br />
				</div>

				<div class="col">
					<label>Confirm Password<label_1> *</label_1></label><br /> <input
						type="password" placeholder="confirm Password" name="cPassword"
						id="cPassword" class="form-control form-control-sm"><br />
				</div>
			</div>
			...
			<input id="btnSave" name="btnSave" type="button" value="Sign Up"
